  ...
  <div class="container-xl container-fluid content-space-1 content-space-md-2 px-4 px-md-8 px-lg-10">
    <div class="row justify-content-lg-between align-items-lg-center">
      <div class="col-md-10 col-lg-5 mb-9 mb-lg-0">
        <h1 class="text-white">Inscribete a nuestra travesia</h1>
        <p class="text-white-70">Ambalema - Domingo 20 de Agosto</p>
            ...
            <div class="d-flex align-items-center">
              ...
              <div class="flex-grow-1 ms-3">
                ...
                <span class="blockquote-footer-source">
                  Pijaos Bike | Lideres de Organización
                </span>
              </div>
            </div>
          </figcaption>
