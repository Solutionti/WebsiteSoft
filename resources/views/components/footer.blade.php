<footer>
  <div class="container">
    <div class="row justify-content-lg-between content-space-t-2 mt-2">
        ...
        <div class="d-flex align-items-start flex-column h-100">
          ...
          <p class="text-muted mt-3">
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nesciunt deleniti, molestiae
             amet iusto asperiores corrupti! Debitis saepe.
          </p>
        </div>
      </div>
    ...
    <div class="row align-items-sm-center mt-3">
      <div class="col-sm mb-1 mb-sm-0">
        <ul class="list-inline mb-0">
          <li class="list-inline-item">
            <a class="btn btn-soft-secondary btn-md btn-icon" href="#">
      ...
      <div class="col-sm-auto">
        <ul class="list-inline list-separator">
          <li class="list-inline-item">
            <a class="link-sm link-secondary" href="#">© Todos los derechos solutionti.com.</a>
          </li>
        </ul>
      </div>
    </div>
