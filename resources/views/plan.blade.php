...
<main id="content" role="main">
  <div class="">
    <div class="container text-center  content-space-t-lg-5">
      <h1 class="display-4">Nuestro plan de precios simplificado</h1>
          ...
          <span class="form-switch-promotion-container">
            <span class="form-switch-promotion-body">
              ...
              <span class="form-switch-promotion-text">
                <span class="badge bg-primary rounded-pill ms-1">Ahorra hasta 10%</span>
              </span>
            </span>
          </span>
        </label>
      ...
      <div class="col-md mb-3 mb-md-0">
        <div class="position-relative">
          ...
          <figure class="position-absolute bottom-0 start-0 mb-n7 ms-n7" style="width: 9rem;">
            <img class="img-fluid" src="https://htmlstream.com/preview/front-v4.2/html/assets/svg/components/dots.svg" alt="Image Description">
          </figure>
...
<div class="container mt-5">
  <div class="row">
    <div class="col-md-12 text-center">
        <h2>Todos los planes de suscripción incluyen estas potentes funciones</h2>
        <p class="lead">Agregamos nuevas herramientas y características regularmente.</p>
    </div>
  </div>
</div>
